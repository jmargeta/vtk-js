...
function vtkInteractorStyleManipulator(publicAPI, model) {
  ...
  //-------------------------------------------------------------------------
  const getManipulator = (index, list) => {
    return index > list.length ? null : list[index];
  };

  //-------------------------------------------------------------------------
  publicAPI.getMouseManipulator = (index) =>
    getManipulator(index, model.mouseManipulators);

  //-------------------------------------------------------------------------
  publicAPI.getVRManipulator = (index) =>
    getManipulator(index, model.vrManipulators);

  //-------------------------------------------------------------------------
  publicAPI.getGestureManipulator = (index) =>
    getManipulator(index, model.gestureManipulators);
  ...
  publicAPI.addMouseManipulator = (manipulator) =>
    addManipulator(manipulator, mouseManipulators);

  //-------------------------------------------------------------------------
  publicAPI.addVRManipulator = (manipulator) =>
    addManipulator(manipulator, vrManipulators);

  //-------------------------------------------------------------------------
  publicAPI.addGestureManipulator = (manipulator) =>
    addManipulator(manipulator, gestureManipulators);
